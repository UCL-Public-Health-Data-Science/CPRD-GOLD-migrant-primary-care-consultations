---
title: "Baseline_characteristics - Annual cohort: London only"
...
cohort_England_2015_2020 <- droplevels(cohort_England_2015_2020)
...
cohort_England_2015_2020$year_cohort_entry <- as.factor(cohort_England_2015_2020$year_cohort_entry)

# Make studyyear a factor in annual files ----

## Full cohort
cohort_England_2015_2020_annual_records$studyyear <- as.factor(cohort_England_2015_2020_annual_records$studyyear)
...
### All rows excluding 
table1 <- cohort_England_2015_2020 %>%
...
table1b <- cohort_England_2015_2020_annual_records %>%
...
# Migcertainty 
table2 <- cohort_England_2015_2020 %>% 
...
table2b <- cohort_England_2015_2020_annual_records %>%
