...
load(file = "filepath/England_2015_2020_aggregate_weekly_conscounts_migstatus_ethnicity18cat.Rdata")
...
write.csv(number_cons_migstatus, "filepath/number_of_consultations_by_migstatus.csv" )
...
save(IRs_pandemic_combined, file="filepath/IRs_pandemic_combined.Rdata")
...
write.csv(all_incladjustmentperiod_nolaggedresiduals, "filepath/all_incladjustmentperiod_nolaggedresiduals.csv" )
...
Box.test(response_res, type = 'Ljung-Box') # p<0.05 - evidence of autocorrelation 
...
write.csv(all_incladjustmentperiod_laggedresiduals, "filepath/all_incladjustmentperiod_laggedresiduals.csv" )
...
write.csv(F2F_nolaggedresiduals, "filepath/F2F_nolaggedresiduals.csv" )
...
Box.test(response_res, type = 'Ljung-Box') # p <0.05 - there is evidence of autocorrelation
...
write.csv(F2F_laggedresiduals, "filepath/F2F_laggedresiduals.csv" )
...
write.csv(F2Fcons_RRs, "filepath/F2Fcons_RRs_England.csv" )
...
write.csv(phone_nolaggedresiduals, "filepath/phone_nolaggedresiduals.csv" )
...
write.csv(phone_laggedresiduals, "filepath/phone_laggedresiduals.csv" )
...
write.csv(phonecons_RRs, "filepath/phonecons_RRs_England.csv" )
...
ggsave('filepath/combined_England_plot.png')
...
save(RRs_England, file = 'filepath/RRs_England.Rdata')
...
write.csv(allcons_RRs_0_15years, "filepath/allcons_RRs_0_15years.csv" )
...
write.csv(allcons_RRs_16_24years, "filepath/allcons_RRs_16_24years.csv" )
...
write.csv(allcons_RRs_25_34years, "filepath/allcons_RRs_25_34years.csv")
...
write.csv(allcons_RRs_35_49years, "filepath/allcons_RRs_35_49years.csv")
...
write.csv(allcons_RRs_50_64years, "filepath/allcons_RRs_50_64years.csv")
...
write.csv(allcons_RRs_65plusyears, "filepath/allcons_RRs_65plusyears.csv" )
...
ggsave('filepath/combined_age_subgroup_plot.png')
...
RRs_agesubcohort <- bind_cols(allcons_RRs_0_15years, allcons_RRs_16_24years, allcons_RRs_25_34years,
  ...
  rename('Variable' = `var...1`)
save(RRs_agesubcohort, file = 'filepath/RRs_agesubcohort.Rdata')
...
write.csv(all_incladjustmentperiod_laggedresiduals_london, "filepath/all_incladjustmentperiod_laggedresiduals_london.csv" )
...
write.csv(allcons_RRs_london, "filepath/allcons_RRs_london.csv" )
...
write.csv(F2F_nolaggedresiduals_london, "filepath/F2F_nolaggedresiduals_london.csv" )
...
write.csv(F2Fcons_RRs_london, "filepath/F2Fcons_RRs_london.csv" )
...
write.csv(phone_nolaggedresiduals_london, "filepath/phone_nolaggedresiduals_london.csv" )
...
write.csv(phone_laggedresiduals_london, "filepath/phone_laggedresiduals_london.csv" )
...
write.csv(phonecons_RRs_london, "filepath/phonecons_RRs_london.csv" )
...
ggsave('filepath/combined_London_plot.png')
...
RRs_London <- bind_cols(allcons_RRs_london, F2Fcons_RRs_london, phonecons_RRs_london) %>%
  dplyr::select(`var...1`, allcons, F2Fcons, phonecons) %>%
  rename('Variable' = `var...1`)
save(RRs_London, file = 'filepath/RRs_London.Rdata')
...
ggsave('filepath/all_cons_IR_England_migstatus_ethnicity.png')
...
ggsave('filepath/F2F_cons_IR_England_migstatus_ethnicity.png')
...
ggsave('filepath/phone_cons_IR_England_migstatus_ethnicity.png')
...
write.csv(migstatus_ethnicity_all_incladjustmentperiod_nolaggedresiduals, "filepath/migstatus_ethnicity_all_incladjustmentperiod_nolaggedresiduals.csv" )
...
write.csv(migstatus_ethnicity_all_incladjustmentperiod_laggedresiduals, "filepath/migstatus_ethnicity_all_incladjustmentperiod_laggedresiduals.csv" )
...
### Formal test for autocorrelation epirhandbook.com/time-series-and-outbreak-detection.html
response_res <- residuals(final_model_nb_all_lr, type = 'response')
Box.test(response_res, type = 'Ljung-Box') # p>0.05 - accept null hypothesis that residuals come from a white noise series
...
ggsave('filepath/all_cons_migstatus_ethnicity_nb.png')
...
write.csv(allcons_migstatus_ethnicity_RRs_vsWBNMs, "filepath/allcons_migstatus_ethnicity_RRs_vsWBNMs.csv" )
...
write.csv(allcons_migstatus_ethnicity_RRs_vsNMs, "filepath/allcons_migstatus_ethnicity_RRs_vsNMs.csv")
...
save(RRs_England_migstatus_ethnicity, file = 'filepath/RRs_England_migstatus_ethnicity.Rdata')
...
all_cons_migstatus_ethnicity_nb
ggsave('filepath/all_cons_migstatus_ethnicity18cat_nb.png')
...
write.csv(allcons_migstatus_ethnicity18cat_RRs_vsNMs, "filepath/allcons_migstatus_ethnicity_18cat_RRs_vsNMs.csv")
...
RRs_England_migstatus_ethnicity18cat <- allcons_migstatus_ethnicity18cat_RRs_vsNMs %>%
  ...
  mutate(RR95CI = paste0(estimate, ' (', lower, '-', upper,')')) %>%
  dplyr::select(var, RR95CI)
save(RRs_England_migstatus_ethnicity18cat, file = 'filepath/RRs_England_migstatus_ethnicity18cat.Rdata')
...
#ggsave('filepath/all_cons_IR_England_migcertainty.png')
...
#ggsave('filepath/F2F_cons_IR_England_migcertainty.png')
...
#ggsave('filepath/phone_cons_IR_England_migcertainty.png')
...
write.csv(all_incladjustmentperiod_nolaggedresiduals_migcertainty, "filepath/all_incladjustmentperiod_nolaggedresiduals_migcertainty.csv" )
...
write.csv(all_incladjustmentperiod_laggedresiduals_migcertainty, "filepath/all_incladjustmentperiod_laggedresiduals_migcertainty.csv" )
...
write.csv(allcons_RRs_migcertainty, "filepath/allcons_RRs_migcertainty.csv")
...
write.csv(F2F_incladjustmentperiod_nolaggedresiduals_migcertainty, "filepath/F2F_incladjustmentperiod_nolaggedresiduals_migcertainty.csv" )
...
write.csv(F2F_incladjustmentperiod_laggedresiduals_migcertainty, "filepath/F2F_incladjustmentperiod_laggedresiduals_migcertainty.csv" )
...
#ggsave('filepath/F2F_cons_nb_migcertainty.png')
...
write.csv(F2Fcons_RRs_migcertainty, "filepath/F2Fcons_RRs_migcertainty.csv" )
...
write.csv(phone_incladjustmentperiod_nolaggedresiduals_migcertainty, "filepath/phone_incladjustmentperiod_nolaggedresiduals_migcertainty.csv" )
...
write.csv(phone_incladjustmentperiod_laggedresiduals_migcertainty, "filepath/phone_incladjustmentperiod_laggedresiduals_migcertainty.csv" )
...
#ggsave('filepath/phone_cons_nb_migcertainty.png')
...
write.csv(phonecons_RRs_migcertainty, "filepath/phonecons_RRs_migcertainty.csv" )
...
ggsave('filepath/combined_migcertainty_plot.png')
...
RRs_migcertainty <- bind_cols(allcons_RRs_migcertainty, F2Fcons_RRs_migcertainty, phonecons_RRs_migcertainty) %>%
  dplyr::select(`var...1`, allcons, F2Fcons, phonecons) %>%
  rename('Variable' = `var...1`)
save(RRs_migcertainty, file = 'filepath/RRs_migcertainty.Rdata')


# 10_SENSITIVITY ANALYSIS: Cohort matched on age_data_start, year_data_start, prac_region, IMD and gender -------
...
write.csv(all_incladjustmentperiod_nolaggedresiduals_ds, "results/01_Consultations/its_analysis/all_incladjustmentperiod_nolaggedresiduals_ds.csv" )
...
write.csv(all_incladjustmentperiod_laggedresiduals_ds, "filepath/all_incladjustmentperiod_laggedresiduals_ds.csv" )
...
write.csv(allcons_RRs_ds, "filepath/allcons_RRs_ds.csv")
...
write.csv(F2F_nolaggedresiduals_ds, "filepath/F2F_nolaggedresiduals_ds.csv" )
...
write.csv(F2F_laggedresiduals_ds, "filepath/F2F_laggedresiduals_ds.csv" )
...
write.csv(F2Fcons_RRs_ds, "filepath/F2Fcons_RRs_ds.csv" )
...
write.csv(phone_nolaggedresiduals_ds, "filepath/phone_nolaggedresiduals_ds.csv" )
...
write.csv(phone_laggedresiduals_ds, "filepath/phone_laggedresiduals_ds.csv" )
...
write.csv(phonecons_RRs_ds, "filepath/phonecons_RRs_ds.csv" )
...
ggsave('filepath/combined_England_plot_ds.png')
...
RRs_England_SA <- bind_cols(allcons_RRs_ds, F2Fcons_RRs_ds, phonecons_RRs_ds) %>%
  dplyr::select(`var...1`, allcons, F2Fcons, phonecons) %>%
  rename('Variable' = `var...1`)
save(RRs_England_SA, file = 'filepath/RRs_England_SA.Rdata')
