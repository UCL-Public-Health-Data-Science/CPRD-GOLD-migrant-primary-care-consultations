---
title: "Baseline_characteristics - ITS cohort: sensitivity analysis 3 matched on age at study start, practice region and gender only"
...
pacman::p_load(tidyverse,lubridate, Hmisc, epitools, data.table, epiR, flextable, rmarkdown,
               gtsummary)
...
matched_its_cohort <- droplevels(matched_its_cohort_SA3)
matched_its_annual_records <- droplevels(matched_its_annual_records_SA3)
