...
# Load files
load(file = "filepath/IR_allpatients_overall_migstatus.Rdata")
load(file = "filepath/IR_allpatients_overall_migstatus_studyyear.Rdata")
load(file = "filepath/IR_allpatients_overall_migcertainty.Rdata")
load(file = "filepath/IR_allpatients_overall_migcertainty_studyyear.Rdata")
...
# Set working directory ----
setwd("filepath")
load(file = "filepath/IRs_pandemic_combined.Rdata")
...
# Load data
load(file = "filepath/RRs_England.Rdata")
...
# Load data
load(file = "filepath/RRs_agesubcohort.Rdata")
...
# Load data
load(file = "filepath/RRs_London.Rdata")
...
# Set working directory ----
setwd("filepath/01_all_patients")

# Load data
load(file = "filepath/RRs_England_migstatus_ethnicity.Rdata")
...
# Load data
load(file = "filepath/RRs_migcertainty.Rdata")
...
# Load data
load(file = "filepath/RRs_agesubcohort_migcertainty.Rdata")
...
# Load data
load(file = "filepath/RRs_England_SA.Rdata")
...
load(file="filepath/int_effects_all_ethnicities.Rdata")
...
load(file="filepath/ethnicity18cat_interactions_table.Rdata")
load(file="filepath/int_effects_all_ethnicat18.Rdata")
...
# Load data
load(file = "filepath/RRs_England_migstatus_ethnicity18cat.Rdata")
